...
public class UsersQueueExtension implements
    ...
    static {
        ...
        WITH_FRIEND_USERS.add(new StaticUser("duck", "1234", "dima", null, null));
        WITH_INCOME_REQUEST_USERS.add(new StaticUser("anna", "12345", null, "bee", null));
        WITH_OUTCOME_REQUEST_USERS.add(new StaticUser("barsik", "12345", null, null, "ben"));
    }
